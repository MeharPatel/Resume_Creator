...
export const ResumePreview = ({ formData, selectedTemplate, setSelectedTemplate }) => {
  const { toPDF, targetRef } = usePDF({
    filename: `${formData.firstName}_${formData.lastName}_Resume.pdf`,
    page: {
      margin: { top: 10, right: 10, bottom: 10, left: 10 }, // Margins in mm
      format: 'a4',
    },
    resolution: 2,
  });
      ...
      <div className="flex flex-col lg:flex-row gap-6 justify-center items-center">
        ...
        >
          ...
          {(formData.socialLinks.github ||
            ...
            <div className="grid grid-cols-2 gap-1 mb-4 no-break">
              {formData.socialLinks.github && (
                <div className="flex">
          ...
          {formData.education.length > 0 && (
            <section className="mb-4">
              ...
              {formData.education.map((edu, index) => (
                <div key={index} className="mb-4 no-break">
                  <div className="flex">
          ...
          {formData.achievements.length > 0 && (
            <section className="mb-4">
              ...
              {formData.achievements.map((achievement, index) => (
                <div key={index} className="mb-1 flex no-break">
