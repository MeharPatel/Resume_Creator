export const templates = {
    multipage:{
        ...
        modern: {
            resume_container: "bg-white shadow-xl a4_page times_new_roman",
            ...
            itemSubtitle: "text-sm text-blue-600 font-bold",
            itemDescription: "text-sm text-gray-700 mt-1 leading-relaxed font-medium",
            customSection: "pl-4 border-l-4 border-blue-500",
            customSectionTitle: "text-2xl font-bold text-blue-700 pb-3",
            customSectionItems: "border-2 border-blue-500 text-gray-900 px-3 pt-0 pb-3 flex justify-center items-center rounded-md text-sm font-medium",
            skill: "border-2 border-blue-500 text-gray-900 px-3 pt-0 pb-3 flex justify-center items-center rounded-md text-sm font-medium",
        ...
        creative: {
            ...
            customSectionItems: "bg-purple-200 border-l-4 border-purple-500 font-medium px-3 pt-0 pb-3 flex justify-center items-center rounded-lg text-sm",
            skill: "bg-purple-200 border-l-4 border-purple-500 text-gray-700 font-medium px-3 pt-0 pb-3 flex justify-center items-center rounded-lg text-sm",
    ...
    singlepage: {
        darkTech: {
            resume_container: "bg-gray-900 text-gray-100 a4_page_single",
